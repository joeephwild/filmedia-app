        ...
        {currentProfile.map((item, i) => (
             ...
             <div className="w-[100%] h-screen">
               ...
               <div className="relative flex justify-start px-5 -mt-24 mb-5 w-full">
                 ...
                 <div className="flex flex-wrap justify-right gap-2 sm:gap-4 mt-8 absolute bottom-0 right-0 mr-5">
                   <button className="text-white-900 hover:text-green-700 p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
                     <svg
                   ...
                   <button className="text-white-900 hover:text-green-700 p-1 sm:p-2  inline-flex items-center  dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
                     <svg
                       className="w-5 h-5 fill-current"
                       role="img"
                       viewBox="0 0 24 24"
                   ...
                   <button className="text-white-900 hover:text-green-700 p-1 sm:p-2  inline-flex items-center dark:text dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
                     <svg
                       className="w-5 h-5 fill-current"
                       xmlns="http://www.w3.org/2000/svg"
                       viewBox="0 0 16 16"
               ...
               <div className="">
                 <div className="px-7 mb-8">
                   ...
                   <p className="text-gray-400 mt-2 dark:text-gray-400">{item.categories}</p>
                   <p className="mt-2 text-lg font-bold font-OpenSans-Bold text-[#ffffff] max-w-[50rem]">
                   {truncate(item.desc, 170)}
                   </p>
                 </div>
                 <div className="flex mx-5 space-x-4 my-9">
                   ...
                   <button  className="border-2 border-white px-4 py-2 rounded-lg text-lg font-bold text-gray-500">
                     Follow
                   </button>
                   {/** right buttons */}
                   <div></div>
